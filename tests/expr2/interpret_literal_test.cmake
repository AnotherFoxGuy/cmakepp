function(test)
  ...
  test_uut(
    "{expression_type:'literal', value_type:'unquoted_string', value:'a'}" "a")
  # single separated token with space
  test_uut(
    "{expression_type:'literal', value_type:'unquoted_string', value:'a\\\\ b'}"
    "a b")
  # single single quoted token
  test_uut(
    "{expression_type:'literal', value_type:'single_quoted_string', value:'a'}"
    "'a'")
  # single double quoted token
  test_uut(
    "{expression_type:'literal', value_type:'double_quoted_string', value:'a'}"
    "\"a\"")
  # number
  test_uut("{expression_type:'literal', value_type:'number', value:'123'}"
           "123")
  # bool, true
  test_uut("{expression_type:'literal', value_type:'bool', value:'true'}"
           "true")
  # bool, false
  test_uut("{expression_type:'literal', value_type:'bool', value:'false'}"
           "false")
  # null
