function(test)
  ...
  # message("Test inconclusive - too undeterministic") return() fail test
  # http_get("http://notahost.tld") ans(res) assert(NOT res)
  ...
  # fails if you have  a router that displays a custom search page when it
  # cannot resolve the host.  (*** t-online)
