function(test)
    ...
    return()
    # { name:<string>, author:<single line string>, copyright_range: [<begin:<year>> [<end:<year>>]] license_name:'' license_url:'' license:<multi line string>,
  ...
  ")
    ...
    # Xxx_FIND_QUIETLY # do not complain Xxx_FIND_REQUIRED #use fatal errror if not found

    # Xxx_FIND_COMPONENTS Xxx_FIND_REQUIRED_Yyy

    # Xxx_FIND_VERSION Xxx_FIND_VERSION_MAJOR Xxx_FIND_VERSION_MINOR Xxx_FIND_VERSION_PATCH Xxx_FIND_VERSION_TWEAK Xxx_FIND_VERSION_COUNT Xxx_FIND_VERSION_EXACT

    # Xxx_INCLUDE_DIRS Xxx_LIBRARIES Xxx_DEFINITIONS Xxx_EXECUTABLE Xxx_Yyy_EXECUTABLE Xxx_LIBRARY_DIRS Xxx_ROOT_DIR Xxx_WRAP_Yy Xxx_VERSION_Yy Xxx_Yy_FOUND Xxx_FOUND
    # Xxx_NOT_FOUND_MESSAGE Xxx_RUNTIME_LIBRARY_DIRS Xxx_VERSION_STRING Xxx_VERSION_MAJOR Xxx_VERSION_MINOR Xxx_VERSION_PATCH Xxx_LIBRARY Xxx_Yy_LIBRARY Xxx_INCLUDE_DIR
    # Xxx_Yy_INCLUDE_DIR
    ...
    #
    # This software is distributed WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the License for more
    # information.
    # =============================================================================
    ...
    # set(JPEG_NAMES ${JPEG_NAMES} jpeg) find_library(JPEG_LIBRARY NAMES ${JPEG_NAMES} )

    # handle the QUIETLY and REQUIRED arguments and set JPEG_FOUND to TRUE if all listed variables are TRUE include(${CMAKE_CURRENT_LIST_DIR}/FindPackageHandleStandardArgs.cmake)
    # FIND_PACKAGE_HANDLE_STANDARD_ARGS(JPEG DEFAULT_MSG JPEG_LIBRARY JPEG_INCLUDE_DIR)

    # if(JPEG_FOUND) set(JPEG_LIBRARIES ${JPEG_LIBRARY}) endif()

    # Deprecated declarations. set (NATIVE_JPEG_INCLUDE_PATH ${JPEG_INCLUDE_DIR} ) if(JPEG_LIBRARY) get_filename_component (NATIVE_JPEG_LIB_PATH ${JPEG_LIBRARY} PATH) endif()
