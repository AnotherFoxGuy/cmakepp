function(test)
  ...
  test_uri("../asd/../../bsd/csd/dsd/../../esd/./fsd"
           "{normalized_segments:['..','..','bsd', 'esd', 'fsd']}")
  # examples
  # test_uri("'scheme1+http://user:password@102.13.44.32:234/C:\\Progr%61m
  # Files(x86)/dir number 1\\file.text.txt?asd=23#asd'" "{}")
  # test_uri("https://www.google.de/u/0/mail/?arg1=123&arg2=arg4#readmails some
  # other data" "{}" --print) test_uri("C:\\windows\\path" "{}" --print)
  ...
  test_uri(
    "//becker.tobi:asdasd@192.168.0.1:2313/path/to/nirvana"
    "{password:'asdasd', user_name:'becker.tobi', ip:'192.168.0.1', port:'2313'}"
  )
  ...
  test_uri("C:\\test\\path" "{net_path:'/C:/test/path'}") # because file:// is
                                                          # prepended it is a
                                                          # net_path
  test_uri("/test" "{net_path:'/test'}") # because file:// is prepended it is a
                                         # net_path
  ...
  test_uri("D:/" "{path:'/D:/'}")
  test_uri(
    "\"C:/Program Files(x86)/Microsoft Visual Studio/Common7\""
    "{path:'/C:/Program%20Files(x86)/Microsoft%20Visual%20Studio/Common7'}")
  test_uri("https://www.google.de/u/20/view.xmls?asd=32#showme"
           "{path:'/u/20/view.xmls'}")
  ...
  test_uri("'C:\\Program Files\\cmake\\bin\\cmake.exe'"
           "{segments: ['C:','Program Files', 'cmake', 'bin', 'cmake.exe']}")
  ...
  test_uri("test.txt.xml"
           "{file:'test.txt.xml' , file_name:'test.txt', extension:'xml'}")
