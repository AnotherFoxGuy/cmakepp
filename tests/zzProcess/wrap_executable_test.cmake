function(test)
    ...
    # cmake_script_test(--async-wait --process-handle) ans(res) assertf({res.pid} MATCHES "[1-9][0-9]*")
    ...
    # assert that --exit-code  returns the correct return code and working directory is correct
