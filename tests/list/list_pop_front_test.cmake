function(test)
    ...
    # performance test index_range(1 1000) ans(lst) timer_start(timer) while(true) list_pop_front(lst) ans(res) if(NOT res) break() endif()

    # endwhile() timer_print_elapsed(timer)
