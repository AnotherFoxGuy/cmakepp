function(test)
  function(range2_parse range)
    ...
    set(regex_range
        ":|${bracket_open_code}|${bracket_close_code}|\\-|\\$|n|[0-9]+")
    ...
    while(true)
      ...
      elseif("${token}" STREQUAL "${bracket_open_code}")
        ...
        elseif("${phase}" STREQUAL "end")
          ...
          throw(
            "invalid inclusivity: inclusivity may only be set for begin/end")
        endif()
  ...
  function(range2_indices n range)
    ...
    map_import_properties(${range} begin end increment begin_inclusivity
                          end_inclusivity)
