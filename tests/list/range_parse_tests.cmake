function(test)
    ...
    # range_parse("(") # defaults to "(n)" ans(res) assert("${res}" EQUALS n:n:1:false:false:-1:false)

    # range_parse(")") # defaults to [n) ans(res) assert("${res}" EQUALS n:n:1:true:false:0:false)

    # range_parse("[") # defaults to [n) ans(res) assert("${res}" EQUALS n:n:1:true:false:0:false)

    # range_parse("]") # defaults to [n] ans(res) assert("${res}" EQUALS n:n:1:true:true:1:false)
