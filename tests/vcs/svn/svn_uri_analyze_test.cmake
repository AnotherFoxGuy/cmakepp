function(test)
  ...
  # { input: <string> uri: <uri string> base_uri: <uri string> relative_uri:
  # <path> ref_type: "branch"|"tag"|"trunk" ref: <string> revision: <rev> }

  svn_uri_analyze("https://github.com/toeb/test_repo/trunk/asdbsd/sd"
                  --revision 3)
  ans(res)

  assertf("{res.input}" STREQUAL
          "https://github.com/toeb/test_repo/trunk/asdbsd/sd")
  assertf("{res.uri}" STREQUAL
          "https://github.com/toeb/test_repo/trunk/asdbsd/sd")
  ...
  assertf("{res.input}" STREQUAL
          "https://github.com/toeb/test_repo/branches/b1")
