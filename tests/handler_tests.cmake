...
{callable: 'test_func', display_name: 'command3', id:'3', labels:['cmd3','cmd_3']}
  ...
  # valid handler func
  assert_matches(
    "{output:'asdasdf',handler:{callable:'test_func'}}" handler_execute
    ("{callable:'test_func'}" "{input:'asdf'}" "{output:'asd'}"))
  # invalid handler func assert_matches("{output:'asd',
  # error:'handler_invalid'}" handler_execute("{callable:'non_existent_func'}"
  # "{input:'asdf'}" "{output:'asd'}"))
