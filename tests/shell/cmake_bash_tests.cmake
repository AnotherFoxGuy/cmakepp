function(test)
    ...
    # seems to cause problems dirs() ans(res) assert(NOT res) pushd() dirs() ans(res) assert("${res}" STREQUAL "${test_dir}") cd(mydir) pwd() ans(res) assert("${res}" STREQUAL
    # "${test_dir}/mydir") popd() pwd() ans(res) assert("${res}" STREQUAL "${test_dir}")
    #
