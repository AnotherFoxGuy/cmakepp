...
# get temp dir which is needed by a couple of functions in cmakepp first uses
# env variable TMP if it does not exists TMPDIR is used if both do not exists
# current_list_dir/tmp is used
if(UNIX)
...
kv(keep_temp
   ...
   0
   DESCRIPTION
   "does not delete temporary files after")
kv(temp_dir
   LABELS
   --temp-dir
   MIN
...
kv(cache_dir
   ...
   1
   DESCRIPTION
   "the directory used for caching data"
   DEFAULT
   "${cmakepp_cache_dir}/cmakepp")
kv(bin_dir
   LABELS
   --bin-dir
   MIN
...
# check if in script mode and script file is equal to this file then invoke
# either cli mode
cmake_entry_point()
ans(entry_point)
...
set(CMAKEPP_VERSION
    "${CMAKEPP_VERSION_MAJOR}.${CMAKEPP_VERSION_MINOR}.${CMAKEPP_VERSION_PATCH}"
)
