...
function(cmakepp_compile target_file)
    ...
    foreach (line ${cmakepp_main_file})
        ...
        elseif ("_${line}" STREQUAL "_include(\"\${cmakepp_base_dir}/cmake/type/parameter_definition.cmake\")")
            file(READ "${base_dir}/cmake/type/parameter_definition.cmake" content)
