...
tries to parse a delimited string returns either the original or the parsed
...
**Examples** set(input "word") string_take(input "w") # => input equals "ord",
