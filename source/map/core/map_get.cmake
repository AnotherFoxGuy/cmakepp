...
# faster way of accessing map.  however fails if key contains escape sequences,
# escaped vars or @..@ substitutions if thats the case comment out this macro
macro(map_get __map_get_map __map_get_key)
  ...
  if(NOT __ans)
    get_property(
      __map_get_property_exists GLOBAL
      PROPERTY "${__map_get_property_ref}"
      SET)
    if(NOT __map_get_property_exists)
      json_print("${__map_get_map}")
      message(
        FATAL_ERROR
          "map '${__map_get_map}' does not have key '${__map_get_key}'")
    endif()
  endif()
endmacro()
