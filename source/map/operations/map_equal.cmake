# compares two maps and returns true if they are equal order of list values is
# important order of map keys is not important cycles are respected.
function(map_equal lhs rhs)
  ...
  # else lhs and rhs might be maps if they are not return false
  is_map(${lhs})
  ans(lhs_ismap)
  ...
  # if already visited return true as a parent call will correctly determine
  # equality
