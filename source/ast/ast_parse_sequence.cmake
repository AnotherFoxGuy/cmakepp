function(ast_parse_sequence) # definition stream create_node definition_id
    ...
    # deref ref array
    # address_get(${sequence} ) ans(sequence)

    # save current stream message("push")
    token_stream_push(${stream})

    # empty var for sequence
    set(ast_sequence)

    # loop through all definitions in sequence adding all resulting nodes in order to ast_sequence
