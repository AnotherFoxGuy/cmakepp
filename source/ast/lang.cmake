function(lang target context)
    ...
    foreach(input ${required_inputs})
        # message_indent_push() message("getting ${input} ${required_inputs}")

        lang("${input}" ${context})
        ans(res)
        # message("got ${res} for ${input}") message_indent_pop()
    ...
    foreach(key ${keys})
        ...
        ans(val)
        # message("key ${key} val ${val}") string(REPLACE "\\" "\\\\"  val "${val}") string(REPLACE "\"" "\\\"" val "${val}")
