function(ast_eval ast context)
  ...
  while(true)
    ...
    ans(eval_command)
    # message("eval command ist ${eval_command}") avaible vars ast context
    # ast_language ast_evaluators available commands ast_evaluator_table
    if(COMMAND "${eval_command}")
      ast_evaluator_table(${type})
      ans(res)
      return_ref(res)
    endif()
    # if(COMMAND "${eval_command}") eval("${eval_command}(\"${ast}\"
    # \"${scope}\")") ans(res) return_ans() endif()
  endwhile()
endfunction()
