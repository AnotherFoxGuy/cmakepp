# navigates a map structure use '.' and '[]' operators to select next element in
# map e.g.  map_navigate(<map_ref> res "propa.propb[3].probc[3][4].propd")
function(map_navigate result navigation_expression)
  ...
  string(REGEX MATCHALL
               ...
               parts "${navigation_expression}")

  # loop through parts and try to navigate if any part of the path is invalid
  # return ""
  set(current "${ref}")
  foreach(part ${parts})
    ...
    elseif(index_type STREQUAL "[")
      message(
        FATAL_ERROR "map_navigate: indexation '[<index>]' is not supported")
      # get by index
      address_get(${current})
      ans(lst)
