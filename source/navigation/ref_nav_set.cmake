...
function(ref_nav_set base_value expression)
  ...
  set(current_ref)
  # this loop  navigates through existing values using ranges and properties as
  # navigation expressions the 4 vars declared before this comment will be
  # defined
  while(true)
  ...
  # if the expressions are left and create_path is not specified this will cause
  # an error else the rest of the path is created
  ...
  # if there are ranges set the interpret the value as a lsit and set the
  # correct element
