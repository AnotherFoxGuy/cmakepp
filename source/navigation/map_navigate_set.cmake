function(map_navigate_set navigation_expression)
  ...
  while(parts)
    ...
    # message("current ${current}, parts: ${parts}, current_part: ${part},
    # current_index ${index} current_type : ${index_type}") first one could not
    # be ref so create ref and set output
    is_address("${current}")
    ans(isref)
