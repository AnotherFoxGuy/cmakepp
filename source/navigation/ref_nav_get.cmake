...
# returned.
#
# **Examples**<% set(data_input "{a:{b:{c:3},d:[{e:4},{e:5}]}}")
# script("${data_input}") ans(data) function(ref_nav_get_example ) set(expr
# ${ARGN}) ref_nav_get("${data}" ${expr}) ans(res) json("${res}") ans(res)
# return("`ref_nav_get(\\\${data} ${expr}) => ${res}`") endfunction() set(asdas
# 123) %> let `${data}` be `@json(${data_input})` then * @ref_nav_get_example(a)
# * @ref_nav_get_example(a.b.c) * @ref_nav_get_example(a.b.c.d) *
# @ref_nav_get_example(a.d[1].e) * @ref_nav_get_example(a.d[0].e) *
# @ref_nav_get_example(a.d) * @ref_nav_get_example() *
# @ref_nav_get_example(&a.b.c) cmake_policy(SET CMP0054 NEW)
...
function(ref_nav_get current_value)
  ...
  endforeach()
  if(return_lvalue)
    map_capture_new(ref:current_ref property:current_property
                    range:current_ranges value:current_value --reassign)
    return_ans()
  endif()
