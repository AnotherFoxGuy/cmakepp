    ...
    function(query_literal query_literal_instance)
        ...
        if(is_ref)
            ...
            if(false)
                ...
                # if("${query_literal_instance}" MATCHES "^(true)|(false)$") ## boolish map_new() ans(query_literal_definition) map_set(${query_literal_definition} bool
                # ${query_literal_instance}) else() ## just a value -> strequal map_new() ans(query_literal_definition) map_set(${query_literal_definition} strequal
                # ${query_literal_instance}) endif()
            endif()
        endif()
