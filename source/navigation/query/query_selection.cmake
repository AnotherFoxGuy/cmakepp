# `(<query: { <<selector:<navigation expression>> : <query literal>>...  } >
# <any>)-><any>`
#
# selects values depending on the specified query example
# ~~~
# assign(input_data = "{
#   a: 'hello world',
#   b: 'goodbye world',
...
function(query_selection query)
  ...
  foreach(selector ${selectors})
    ...
    # check to see if selector ends with [...] which indicates that action
    # should be performed foreach item
    #
    set(target_property)
