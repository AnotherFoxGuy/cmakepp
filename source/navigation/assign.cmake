...
#
# the assign function allows the user to perform some nonetrivial operations
# that other programming languages allow
#
# Examples
#
function(assign __lvalue __operation __rvalue)
  ...
  if(NOT "${__operation}" MATCHES "^(=|\\+=)$")
    # if no equals sign is present then interpret all args as a simple literal
    # cmake value this allows the user to set an expression to a complicated
    # string with spaces without needing to single quote it
