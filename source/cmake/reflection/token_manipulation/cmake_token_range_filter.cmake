...
function(cmake_token_range_filter range)
    ...
    while(
        ...
        # print_vars(reverse line value type predicate predicate_holds value type ) string(REPLACE "{type}" "${type}" current _predicate "${args}") string(REPLACE "{value}"
        # "${value}" current_predicate "${current_predicate}")
        if(predicate_holds)
