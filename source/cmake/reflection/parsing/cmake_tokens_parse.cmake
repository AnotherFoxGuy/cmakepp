...
function(cmake_tokens_parse code)
    ...
    # this code checks for errors... however it is slow string(REGEX REPLACE "${regex_cmake_token}" "" error "${code}") if(error) throw("could not parse '{error}'" --function
    # cmake_tokens_parse) endif()
