...
# ~~~
#
# returns the environment of cmake the results are cached (--update-cache if
# necesssary)
function(cmake_environment)
  function(_cmake_environment_inner)
    ...
    assign(!result.cmake.default_compiler_version =
           res.CMAKE_CXX_COMPILER_VERSION)
    # map_tryget(${res} CMAKE_SIZEOF_VOID_P) ans(byte_size_voidp) math(EXPR
    # architecture "${byte_size_voidp} * 8") assign(!result.architecture =
    # architecture)
  ...
  define_cache_function(
    _cmake_environment_inner => cmake_environment --generate-key
    "[]()checksum_string({{CMAKE_COMMAND}})" # --refresh
  )
