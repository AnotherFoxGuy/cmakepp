...
function(cmake_environment)
    function(_cmake_environment_inner)
      ...
      CMAKE_CXX_COMPILER_VERSION
        ...
        # ans(byte_size_voidp) math(EXPR architecture "${byte_size_voidp} * 8") assign(!result.architecture = architecture)
    ...
    define_cache_function(_cmake_environment_inner => cmake_environment --generate-key "[]()checksum_string({{CMAKE_COMMAND}})" # --refresh
    )
