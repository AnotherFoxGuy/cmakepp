...
function(target_add_auto)
  ...
  write_compiler_detection_header(
    FILE "${CMAKE_CURRENT_BINARY_DIR}/${targetName}/compiler_detection.h" PREFIX
    ${targetNameUpper}
    COMPILERS GNU MSVC
    VERSION 3.5
  ...
  if(shared)
    ...
    if(MSVC)
      target_compile_options("${targetName}${shared_suffix}" PRIVATE /MP /W4
                                                                     /Zi)
      target_link_libraries("${targetName}${shared_suffix}" version.lib
                            Iphlpapi.lib)
    endif()
  ...
  if(static)
    ...
    if(MSVC)
      target_compile_options("${targetName}${static_suffix}" PRIVATE /MP /W4
                                                                     /Zi)
      target_link_libraries("${targetName}${static_suffix}" version.lib
                            Iphlpapi.lib)
    endif()
  ...
  if(install)
    ...
    install(FILES ${CMAKE_CURRENT_BINARY_DIR}/${targetName}/compiler_detection.h
            DESTINATION ${targetName}/include/${targetName})
    install(
      TARGETS ${targetName}${static_suffix} ${targetName}${shared_suffix}
      EXPORT ${targetName}
  ...
  if(tests)
    ...
    if(test_sources)
      ...
      target_link_libraries("${targetName}_test"
                            "${targetName}${shared_suffix}" gtest)
