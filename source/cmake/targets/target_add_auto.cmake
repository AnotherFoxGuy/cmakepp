...
function(target_add_auto)
    ...
    write_compiler_detection_header(
        FILE "${CMAKE_CURRENT_BINARY_DIR}/${targetName}/compiler_detection.h" PREFIX ${targetNameUpper}
        COMPILERS GNU MSVC
        VERSION 3.5
    ...
    if(shared)
        ...
        target_include_directories("${targetName}${shared_suffix}" PUBLIC "$<BUILD_INTERFACE:${CMAKE_CURRENT_LIST_DIR}/include>" "$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}>"
    ...
    if(static)
        ...
        target_include_directories("${targetName}${static_suffix}" PUBLIC "$<BUILD_INTERFACE:${CMAKE_CURRENT_LIST_DIR}/include>" "$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}>"
                                                                          "$<INSTALL_INTERFACE:${targetName}/include>")
