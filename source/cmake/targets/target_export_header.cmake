function(target_export_header targetName apiName)
  ...
  if("${targetType}" STREQUAL SHARED_LIBRARY)
    target_compile_definitions("${targetName}"
                               PRIVATE "-D${targetNameUpper}_EXPORTS")
  else()
    target_compile_definitions("${targetName}${staticSuffix}"
                               PRIVATE "-D${targetNameUpper}_STATIC")
  endif()
