function(cmake_ast_variable_parse target invocation_token)
  ...
  cmake_token_range_find_next_by_type(${invocation_token}
                                      "(unquoted_argument)|(quoated_argument)")
  ans(name_token)
  ...
  # get the beginning of values the first token after name
  map_tryget(${name_token} next)
  ans(values_begin)
  # get the ending of values the )
