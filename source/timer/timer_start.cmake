...
function(timer_start id)
    ...
    # this is run the first time a timer is started: it calculates a prejudice value (the time it takes from timer_start to timer_elapsed to run) this prejudice value is then
    # subtracted everytime elapse is run thus minimizing the error
