...
# initial version of task_enqueue which is used before cmakepp is loaded ## create invoke later functions function(task_enqueue callable) ## semicolon encode before
# string_encode_semicolon exists string(ASCII  31 us) string(REPLACE ";" "${us}" callable "${callable}") set_property(GLOBAL APPEND PROPERTY __initial_invoke_later_list
# "${callable}") return() endfunction()
