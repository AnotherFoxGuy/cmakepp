...
# promise is resolved
#
# resolves the specified promise returns true if promise could be resolved
# returns false if promise was already resolved returns <null> if resolution was
# a promise and promise will be resolved later
function(promise_resolve promise)
  ...
  # todo is_error("${ARGN}") ans(is_error)
