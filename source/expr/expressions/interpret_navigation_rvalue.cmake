function(interpret_navigation_rvalue tokens)
  ...
  if(${token_count} LESS 2)
    throw("expected at least two tokens (got {token_count})" --function
          interpret_navigation_rvalue)
  endif()
  ...
  if(NOT "${type}" STREQUAL "dot")
    throw("expected second to last token to be a `.`" --function
          interpret_navigation_rvalue)
  endif()
  ...
  # print_vars(rhs.type rhs.argument rhs.code lhs.type lhs.argument lhs.code
  # --plain)
  ...
  set(code
      "get_property(__ans GLOBAL PROPERTY \"${lhs_value}.__object__\" SET)
if(__ans)
