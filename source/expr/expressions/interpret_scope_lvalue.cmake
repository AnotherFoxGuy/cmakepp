# interpret an lvalue needs a rvalue
function(interpret_scope_lvalue tokens)
  ...
  if(NOT "${dollar_token_type}" STREQUAL "dollar")
    throw("first token is not the dollar token" --function
          interpret_scope_lvalue)
  endif()
  ...
  if(NOT "${identifier_token_count}" EQUAL 1)
    throw("expected one identifier token got ${identifier_token_count}"
          --function interpret_scope_lvalue)
  endif()
  ...
  if(NOT "${expression_type}" MATCHES "(literal)|(paren)|(bracket)")
    throw(
      "invalid identifier : expected a literal|paren|bracket as an identifier but got ${expression_type}"
    )
  endif()
  ...
  set(post_code
      "set(\"${identifier_value}\" \${${identifier_value}} PARENT_SCOPE)\n")
