#
# <lhs rvalue>::<rhs rvalue>(<parameter>...) => calls the function pointed to by
# rvalue  using lhs_ rvalue as its first argument then appending the other
# parameters e.g  `'123'::string_length()->3`
function(interpret_bind_call tokens)
  ...
  if(NOT paren_token)
    throw("invalid token count, expected at least 5 got 0" --function
          interpret_bind_call)
  endif()
  ...
  if(NOT "${paren_type}" STREQUAL "paren")
    throw("expected paren token, got ${paren_type}" --function
          interpret_bind_call)
  endif()

  if(NOT callable_token)
    throw("invalid token count, expected at least 5 got 1" --function
          interpret_bind_call)
  endif()

  if(NOT colon1)
    throw("invalid token count, expected at least 5 got 2" --function
          interpret_bind_call)
  endif()
  if(NOT colon2)
    throw("invalid token count, expected at least 5 got 3" --function
          interpret_bind_call)
  endif()

  if(NOT lhs_tokens)
    throw("invalid token count, expected at least 5 got 4" --function
          interpret_bind_call)
  endif()
