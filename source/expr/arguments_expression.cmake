...
# arguments
#
# __sideffects__: * `arguments_expression_result` is a address of an object
# containing all parsed data * scope operations may modify the parent scope of
# the function
#
macro(arguments_expression begin end)
  # eval arguments expression see interpret_cmake_function_parameters
  set(_argn_ ${ARGV})
  arguments_expression_eval_cached(interpret_cmake_function_parameters ""
                                   "_argn_" ${begin} ${end})
