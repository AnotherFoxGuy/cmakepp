...
# CMake file scioe or inside a cmake function scope. You CANNOT use it in a
# loop, if statement, macro etc (everything that has a begin/end) Every
# expression inside that scope (and its subscopes) will be evaluated.
#
...
# following expression in the current code scope is scanned for `$[...]`
# brackets which are in turn lexed,parsed and compiled (see `expr()`) and
# injected into the code which is in turn included
