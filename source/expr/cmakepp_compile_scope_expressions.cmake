...
#
# compiles all expressions in the current scope (file or
...
function(cmakepp_compile_scope_expressions line)
  ...
  set(scope_depth 0)
  # loop through all invocations. and count function/endfunctions break when end
  # of scope found
  while(true)
    cmake_invocation_filter_token_range(
      "${current_begin};" \${invocation_identifier} MATCHES
      "^(endfunction)|(function)$" --take 1)
    ans(invocation)
    if(NOT invocation)
      break()
    endif()
