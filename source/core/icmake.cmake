# spawns an interactive cmake session use @echo off and @echo on to turn
# printing of result off and on use quit or exit to terminate usage: cmake()
function(icmake)
  ...
  while(true)
    ...
    elseif("${cmd}" MATCHES "@string on")
      ...
      # check if cmd is valid cmake todo
      if(NOT strict)
        lazy_cmake("${cmd}")
        ans(cmd)
      endif()
