...
function(cmakepp_require)
  ...
  # uses git functionality of cmakepp v0.0.3 to download the current git
  # repository
  git(clone "${git_uri}.git" "${installation_dir}")

  cmake(-P "${installation_dir}/cmakepp.cmake" cmakepp_compile
        "${installation_dir}/tmp/cmakepp.cmake")
  file(READ "${installation_dir}/tmp/cmakepp.cmake")
  rm(-r "${installation_dir}")
  file(WRITE "${installation_dir}/cmakepp.cmake" )

  # so this line causes a segmentation fault so i'm just gonna ignore it for
  # now... include("${installation_dir}/cmakepp.cmake")
