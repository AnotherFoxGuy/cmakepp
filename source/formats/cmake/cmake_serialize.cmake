function(cmake_serialize)
    ...
    function(cmake_obj_begin)
        ...
        map_append_string(
            ${context} qm "math(EXPR ref \"\${base} + ${ref}\")
...
")
    ...
    function(cmake_obj_end)
        ...
        map_append_string(${context} qm "math(EXPR ref \"\${base} + ${ref}\")
")
    endfunction()
    ...
    function(cmake_obj_keyvalue_begin)
        ...
        map_append_string(
            ${context} qm "set_property(GLOBAL APPEND PROPERTY \"${keystring}.__keys__\" \"${map_element_key}\")
...
")
    ...
    function(cmake_literal)
        ...
        ans(node)
        map_append_string(${context} qm "set_property(GLOBAL APPEND PROPERTY \"${refstring}\" \"${node}\")
")
        return()
    endfunction()
