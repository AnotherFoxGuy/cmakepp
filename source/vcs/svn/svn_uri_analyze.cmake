# svn_uri_analyze(<input:<?uri>> [--revision <rev>] [--branch <branch>] [--tag
# <tag>])-> { input: <string> uri: <uri string> base_uri: <uri string>
# relative_uri: <path> ref_type: "branch"|"tag"|"trunk" ref: <string> revision:
# <rev> }
#
function(svn_uri_analyze input)
  ...
  set(ref_type)
  set(ref)
  if("${formatted_uri}" MATCHES
     "(.*)/(${trunk_dir}|${tags_dir}|${branches_dir})(/|$)")
    ...
    if(uri_ref_type STREQUAL "${tags_dir}" OR uri_ref_type STREQUAL
                                              "${branches_dir}")
