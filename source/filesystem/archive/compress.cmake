# compresses all files specified in glob expressions (relative to pwd) into
# ${target_file} tgz file usage: compress(<file> [<glob> ...]) -
#
function(compress target_file)
  ...
  if(format STREQUAL "application/x-gzip")
    ...
    message(
      FATAL_ERROR "format not supported: ${format}, target_file: ${target_file}"
    )
  endif()
endfunction()
