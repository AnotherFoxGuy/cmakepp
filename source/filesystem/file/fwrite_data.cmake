# fwrite_data(<path> ([--mimetype <mime type>]|[--json]|[--qm]) <~structured
# data?>) -> <structured data>
#
# writes the specified data into the specified target file (overwriting it if it
# exists)
#
# fails if no format could be chosen
#
# format:  if you do not specify a format by passing a mime-type or type flag
# the mime-type is chosen by analysing the file extension - e.g. *.qm files
# serialize to quickmap *.json files serialize to json
#
function(fwrite_data target_file)

  set(args ${ARGN})

  # check first arg is a map with a stored $target_file hidden property then we
  # can use this as the target file this field only exists if fread_data was
  # used to read data
