...
# recursive template calling * returns * the output of the template * scope *
# `pwd()` is set to the templates path * `${template_path}` is set to the path
# of the current template * `${template_dir}` is set to the directory of the
# current template * `${root_template_dir}` is set to the directory of the first
# template run * `${root_template_path}` is set to the path of the first
# template run * `${parent_template_dir}` is set to the calling templates dir *
