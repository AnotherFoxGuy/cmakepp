function(map_template_evaluate_scoped scope)
  # todo -> needs to be implemented to correctly do recursion needs to have max
  # iterations
  if(NOT __recurse)
    set(__recurse true)
    map_new()
  ...
  # set(changed false) foreach(key ${keys}) map_tryget(${value} "${key}")
  # ans(template) map_tryget(${clone} "${key}") ans(previousValue)

  # template_run_scoped(${scope} "${template}" ) ans(value) print_vars(key
  # template value)

  # if(NOT "${value}_" STREQUAL "${previousValue}_") map_set(${clone} "${key}"
  # "${value}") set(changed true) endif() endforeach() endwhile()
