function(semver_parse_lazy version_string)
  ...
  set(version_numbers_regex
      "(${version_number_regex}(\\.${version_number_regex}(\\.${version_number_regex})?)?)"
  )

  # checks if version is of ()-()+() structure and only contains valid
  # characters
  set(version_elements_regex
  ...
  string_split_at_first(version_numbers prerelease_and_metadata
                        "${version_string}" "-")
  ...
  if(version_numbers)
    ...
    # nav("version.numbers" "${version_numbers}") nav("version.major"
    # "${major}") nav("version.minor" "${minor}") nav("version.patch"
    # "${patch}")
  endif()

  # nav("version.prerelease" "${prerelease}") nav("version.metadata"
  # "${metadata}") nav("version.metadatas" "${metadatas}") nav("version.tags"
  # "${tags}")
