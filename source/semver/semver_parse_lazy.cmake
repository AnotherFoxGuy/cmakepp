...
function(semver_parse_lazy version_string)
    ...
    if(version_numbers)
        ...
        # nav("version.numbers" "${version_numbers}") nav("version.major" "${major}") nav("version.minor" "${minor}") nav("version.patch" "${patch}")
    endif()

    # nav("version.prerelease" "${prerelease}") nav("version.metadata" "${metadata}") nav("version.metadatas" "${metadatas}") nav("version.tags" "${tags}")
