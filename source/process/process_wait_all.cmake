# `(<handles: <process handle...>>  [--timeout <seconds>] [--idle-callback
# <callable>] [--task-complete-callback <callable>] )`
#
...
#
# `--idle-callback <callable>` if value is specified it will be called at least
# once and between every query if a task is still running
#
# `--task-complete-callback <callable>` if value is specified it will be called
# whenever a task completes.
#
# *Example* `process_wait_all(${handle1} ${handle1}  --task-complete-callback
# "[](handle)message(FORMAT '{handle.pid}')")` prints the process id to the
# console whenver a process finishes
#
function(process_wait_all)
  ...
  while(running_processes)
    ...
    # message(FORMAT "{current_process.pid} is_running {is_running}
