...
# with COMMAND or parses a single command line call returns a command line
# object: { command:<string>, args: <string>... }
function(command_line_parse)
  ...
  if("${first}_" STREQUAL "COMMAND_")
    ...
    if(arg_count)
      message(
        FATAL_ERROR
          "either use a single command string or a list of 'COMMAND <command> <arg1> <arg2> ...'"
      )
    endif()
