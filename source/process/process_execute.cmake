...
# working directory creates and registers a process handle which is then
# returned this function accepts arguments as encoded lists. this allows you to
# include arguments which contain semicolon and other special string chars. the
# process id of processes start with `process_execute` is always -1 because
# `CMake`'s `execute_process` does not return it. This is not too much of a
# problem because the process will always be terminated as soon as the function
# returns
#
# **parameters** * `<command>` the executable (may contain spaces) * `<arg...>`
# the arguments - may be an encoded list **scope** * `pwd()` used as the
# working-directory **events** * `on_process_handle_created` global event is
# emitted when the process_handle is ready * `process_handle.on_state_changed`
#
# **returns**
# ~~~
# <process handle> ::= {
