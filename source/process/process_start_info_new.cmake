# `(<command string>|<object> [TIMEOUT <n:int>] [WORKING_DIRECTORY ~<path>]
# [--passthru])-><process start info>` `<command string> ::= "COMMAND"?
# <command> <arg...>`
#
...
# }
# ~~~
# the syntax of the process_start_info_new is equivalent to cmake's built in
# `execute_process` command.
#
# the command needs to point to an executable,  preferrably a fully qualified
# path the command_arguments contain an encoded list.  you can specify any
# argument in the execute function - they will be passed along as you write them
# (this deserves extra appreciation because doing so in cmake is hard) If the
# flags you want to pass along to the process conflict with the flags of the
# process function you can always encode them yourself and pass them along as an
# encoded list
#
# *example* * `process_start_info_new(COMMAND cmake -E echo "asd bsd" csd) -> <%
# process_start_info_new(COMMAND cmake -E echo "asd;bsd") ans(info)
