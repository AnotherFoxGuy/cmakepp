...
function(process_list_Linux)
    ...
    foreach(line ${lines})
        ...
        # string(REGEX REPLACE "${ps_regex}" "\\2" tty "${line}") string(REGEX REPLACE "${ps_regex}" "\\3" hh "${line}") string(REGEX REPLACE "${ps_regex}" "\\4" mm "${line}")
        # string(REGEX REPLACE "${ps_regex}" "\\5" ss "${line}") string(REGEX REPLACE "${ps_regex}" "\\6" cmd "${line}") string(STRIP "${cmd}" cmd)
