# windows implementation for start process newer faster version
function(process_start_Windows process_handle)
  ...
  # creates a temporary batch file which gets the process id (get the parent
  # process id wmic....) output pid to file output command_string to
  fwrite_temp(
    "
      @echo off
  ...
  # wait until the pidfile exists and contains a valid pid this seems very
  # hackisch but is necessary as i have not found a simpler way to do it
  while(true)
    if(EXISTS "${pidfile}")
      fread("${pidfile}")
      ans(pid)
