...
function(update_watch_list_clause f watch_list assignments watched_clause)
  ...
  # loop through all literals for watched clause get the currently watched
  # literals from watch clause
  set(current_watch_count 0)

  while(${current_watch_count} LESS 2 AND NOT "${watched_clause_literals}_"
                                          STREQUAL "_")
    ...
    if(NOT "${current_literal}" EQUAL "${new_assignment}")
      ...
      ans(is_assigned)
      if(NOT is_assigned)
        map_append_unique("${watch_list}" "${current_literal}"
                          "${watched_clause}")
