# `()->`
#
# takes a list of clauses and deduces all assignments from unit clauses storing
# them in assignments and returning their literal indices returns conflict if a
# deduced assignment conflicts with an existing assignment return unsatisfied if
# clauses contains at least one unsatisfiable clause
function(bcp_deduce_assignments f clauses assignments)
  ...
  foreach(unit_clause ${unit_clauses})
    ...
    # messaGE(FORMAT "  deduced {f.literal_map.${unit_clause_inverse}} to be
    # false ")
