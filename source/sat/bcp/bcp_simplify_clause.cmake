...
function(bcp_simplify_clause f clause li value)
    ...
    if("${found}" LESS 0)
        # literal not found in clause -> no change if clause was unsatisfied it stays unsatisfied
        return_ref(clause)
    endif()
    ...
    # if clause is not unsatisfied remove false value from clause as it does not change the result of clause
    if(clause)
