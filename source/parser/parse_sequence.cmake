...
#
# if("${sequence_id}" MATCHES "^@") string(SUBSTRING "${sequence_id}" 1 -1 sequence_id) map_set("${result_map}" "${sequence_key}" "${sequence_id}")
#
# else() set(ignore false) set(optional false) if("${sequence_id}" MATCHES "^\\?") string(SUBSTRING "${sequence_id}" 1 -1 sequence_id) set(optional true) endif()
# if("${sequence_id}" MATCHES "^/") string(SUBSTRING "${sequence_id}" 1 -1 sequence_id) set(ignore true) endif()
#
...
#
# if(NOT "${ignore}") map_set("${result_map}" "${sequence_key}" "${res}") endif() endif() endforeach()
