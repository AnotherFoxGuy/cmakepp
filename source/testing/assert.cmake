...
function(assert)
    ...
    # if no message type is set set FATAL_ERROR so execution halts on failing assertion
    ...
    # depending on wether to accumulate the results or not set result to a boolean or append to result list
    if(_ACCU)
        set(lst ${_RESULT})
