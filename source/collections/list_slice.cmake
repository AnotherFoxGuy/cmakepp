# retruns a portion of the list specified. negative indices count from back of
# list
#
function(list_slice __list_slice_lst start_index end_index)
  ...
  # foreach(idx ${indices}) list(GET ${__list_slice_lst} ${idx} value)
  # list(APPEND res ${value}) message("getting value at ${idx} from
  # ${${__list_slice_lst}} : ${value}") endforeach() message("${start_index} -
  # ${end_index} : ${indices} : ${res}" )
  return_ref(res)
endfunction()
