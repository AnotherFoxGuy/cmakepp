...
function(list_parse_descriptor descriptor)
  ...
  # message(FORMAT "value args for {descriptor.id} max:${cut_off} are
  # ${value_args} args: ${args}")
  ...
  # if less than min args are avaiable set error to true but still return the
