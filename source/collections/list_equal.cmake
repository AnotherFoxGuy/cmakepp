# comapres two lists with each other usage list_equal( 1 2 3 4 1 2 3 4)
# list_equal( listA listB) list_equal( ${listA} ${listB}) ... COMPARATOR
# defaults to STREQUAL COMPARATOR can also be a lambda expression COMPARATOR can
# also be EQUAL
function(list_equal)
  set(options)
  ...
  if(NOT ${is_even} EQUAL "0")
    # element count is not divisible by two so the lists cannot be equal because
