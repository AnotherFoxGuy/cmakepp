...
#
# returns the best ranges from the specified indices e.g range_from_indices(1 2
# 3) -> [1:3] range_from_indices(1 2) -> 1 2 range_from_indices(1 2 3 4 5 6 7 8
# 4 3 2 1 9 6 7) -> [1:8] [4:1:-1] 9 6 7
...
macro(__range_from_indices_create_range)
  ...
  # message("done with range: ${begin} ${end} ${increment}
  # ${number_of_indices}")
