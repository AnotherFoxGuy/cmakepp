...
#
# returns the list of indices for the specified range length may be negative
# which causes a failure if any anchors are used (`$` or `n`)
#
# if the length is valid  (`>-1`) only valid indices are returned or failure
# occurs
#
...
function(range_indices length)
  ...
  # foreach partial range in range get the begin and end and increment use
  # cmake's foreach loop to enumerate the range and save the indices remove a
  # index at front and or back if the inclusivity warrants it return the indices
  set(indices)
