...
function(range_parse)
    ...
    # get begin and end_inclusivity chars results in begin_inclusivity and end_inclusivity to be either "<" ">" or " "
    ...
    # transform "<" ">" and " " to a true or false value " " means default inclusivity
    ...
    # create math expression to calculate begin and end if anchors are used negative begin or end is transformed into $-i
    ...
    # calculate length of range (number of elements that are spanned) depending on the orientation of the range
    if(NOT reverse)
