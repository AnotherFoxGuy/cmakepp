...
function(list_range_try_get __lst_ref)
    ...
    # range_indices("${__len}" ${ARGN}) ans(__indices2)

    # set(__indices) foreach(__idx ${__indices2}) if(NOT ${__idx} LESS 0 AND ${__idx} LESS ${__len} ) list(APPEND __indices ${__idx}) endif() endforeach()
