function(key key)
  ...
  if(NOT current_map)
    message(
      FATAL_ERROR
        "cannot set key for non existing map be sure to call first map() before first key()"
    )
  endif()
  # set current key
...
# key() -> <void>
#
# starts a new property for a map - may only be called after key or map fails if
# current ref is not a map
function(key key)
  stack_pop(quickmap)
  ans(current_key)
