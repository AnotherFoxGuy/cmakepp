...
function(uri_parse str)
    ...
    # if(NOT "${scheme}_"  STREQUAL _) string_slice("${scheme}" 0 -2) ans(scheme) endif()
    ...
    # string_take_regex(str "${query_regex}") ans(query) if(query) string_slice("${query}" 1 -1) ans(query) endif()
    ...
    # string_take_regex(str "${fragment_regex}") ans(fragment) if(fragment) string_slice("${fragment}" 1 -1) ans(fragment) endif()
