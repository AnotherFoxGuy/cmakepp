...
function(uri_normalize_input input_uri)
  ...
  # string_take_regex(input "${uric}+") ans(uri)
  ...
  if(default_file_scheme)
    if(handle_windows_paths)
      # replace backward slash with forward slash for windows paths - non
      # standard behaviour
    ...
    if("_${uri}" MATCHES "^_[a-zA-Z]:")
      # local windows path no scheme -> scheme is file:// <drive letter>: is
      # replaced by /<drive letter>|/ also colon after drive letter is
      # normalized to  ${driveletter_separator}
      string(REGEX REPLACE "^_([a-zA-Z]):(.+)" "\\1${driveletter_separator}\\2"
                           uri "_${uri}")
      set(uri "file:///${uri}")
  ...
  map_capture(${input_uri} uri rest delimited_rest delimiters
