...
function(uri_normalize_input input_uri)
    ...
    if(default_file_scheme)
        if(handle_windows_paths)
            # replace backward slash with forward slash for windows paths - non standard behaviour
        ...
        if("_${uri}" MATCHES "^_[a-zA-Z]:")
            # local windows path no scheme -> scheme is file:// <drive letter>: is replaced by /<drive letter>|/ also colon after drive letter is normalized to
            # ${driveletter_separator}
