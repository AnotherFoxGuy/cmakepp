...
function(http_get uri)
    ...
    if(NOT client_status)
        ...
        if(NOT silent_fail AND NOT return_response)
            rm("${target_path}")
            if("$ENV{TRAVIS}")
                # do not show the query if travis build because it could contain sensitive data
    ...
    # if the response is not to be returnd check if deserialization is wished and and return content
