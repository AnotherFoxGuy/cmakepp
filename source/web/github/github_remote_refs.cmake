# github_remote_refs( <?ref type query>)-> { ref_type:
# "branches"|"tags"|"commits" ref: <name> commit: <sha> }
#
# ref type query ::= "branches"|"tags"|"commits"|"*" returns the remote refs for
...
function(github_remote_refs user repo ref_query)
  ...
  if(ref_query
     AND "${ref_query}" STREQUAL "commits"
     AND ref_name_query)
  ...
  if(ref_query
     AND "${ref_query}" STREQUAL "*"
     OR "${ref_query}" STREQUAL "tags")
  ...
  if(ref_query
     AND "${ref_query}" STREQUAL "*"
     OR "${ref_query}" STREQUAL "branches")
  ...
  if(ref_name_query AND NOT "${ref_name_query}" STREQUAL "*")
    ...
    foreach(ref ${refs})
      ...
      ans(commit)
      if("${ref_name_query}" STREQUAL "${ref_name}" OR "${ref_name_query}"
                                                       STREQUAL "${commit}")
