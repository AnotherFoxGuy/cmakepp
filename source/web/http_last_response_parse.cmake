...
# http_log is returned by cmake's file(DOWNLOAD|PUT LOG) function layout {
# http_version: http_status_code: http_reason_phrase: http_headers:{}
# http_request:{ http_version: http_request_url: http_method: http_headers:{} }
# }
function(http_last_response_parse http_log)
  ...
  string(REGEX MATCHALL "(${http_response_header_regex})" responses
               "${http_log}")
