function(bitbucket_repositories user)
  ...
  while(true)
    ...
    if(error)
      error(
        "failed to query ${current_uri} http client said: {response.client_message} ({response.client_status})}"
      )
      return()
    endif()
  ...
  # hack because of the way that json_extract_string_value works I have to
  # remove other names Doesn't work properly, but who uses bitbucket in 2020...
