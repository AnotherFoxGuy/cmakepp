function(bitbucket_remote_refs user repo ref_type_query ref_name_query)
  ...
  http_get("${api_uri}/repositories/${user}/${repo}/branches-tags"
           --silent-fail --json)
  ans(refs)
  if(NOT refs)
    return()
  ...
  if("${ref_type_query}_" STREQUAL "*_" OR "${ref_type_query}_" STREQUAL
                                           "branches_")
  ...
  foreach(branch ${branches})
    ...
    if("${ref_name_query}_" STREQUAL "*_" OR "${ref_name_query}_" STREQUAL
                                             "${ref}_")
