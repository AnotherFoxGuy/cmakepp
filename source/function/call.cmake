# dynamic function call method can call the following * a cmake macro or
# function * a cmake file containing a single function * a lambda expression
# (see lambda()) * a object with __call__ operation defined * a property
# reference ie this.method() CANNOT  call * a navigation path no output except
# through return values or referneces
function(call __function_call_func __function_call_paren_open)
  ...
  if(NOT "_${__function_call_paren_open}${__function_call_paren_close}"
     STREQUAL "_()")
    message(
      "open ${__function_call_paren_open} close ${__function_call_paren_close}")
    message(
      WARNING
        "expected opening and closing parentheses for function '${__function_call_func}' '${ARGN}' '${__function_call_args}'"
    )
  endif()
  ...
  if(is_func)
    function_import("${__function_call_func}" as __function_call_import
                    REDEFINE)
    __function_call_import(${__function_call_args})
    return_ans()
  endif()
