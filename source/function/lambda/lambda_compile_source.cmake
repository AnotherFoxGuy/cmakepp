function(lambda2_compile_source source)
  ...
  string(REGEX REPLACE "${regex_delimited_string}" "${string_token}" source
                       "${source}")
  ...
  string(REGEX REPLACE "${string_token}" "${string_token}{__ans}" code
                       "${code}")

  # replace {{<identifier>}} with ${<identifier>}
  string(REGEX REPLACE "{{(${regex_cmake_identifier})}}" "${string_token}{\\1}"
                       code "${code}")
  string(REPLACE "${string_token}" "\$" code "${code}")
