    ...
    foreach(i RANGE ${__args_start} ${__args_end})
        ...
        elseif("${__args_current_token}_" STREQUAL ")_")
            ...
            if("${__args_current_token}" MATCHES "[ \\$\"\\(\\)#\\^\t\r\n\\\;]")
                # encoded list encode cmake string... @ todo this has to be extracted however it does not work correctly because of macro evaluation when using cmake_string_escape2
