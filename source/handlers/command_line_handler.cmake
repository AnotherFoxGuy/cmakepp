function(command_line_handler)
    ...
    # compares the request to the handlers returns the handlers which matches the request can return multiple handlers
    method(find_handler)
    ...
    # executes the specified handler the handler must not be part of this command runner it takes a handler and a request and returns a response object
    ...
    # adds a request handler to this command handler request handler can be any function/function definition or handler object
    method(add_handler)
